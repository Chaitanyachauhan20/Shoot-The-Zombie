...
function setup() {
  ...
  bg = createSprite(displayWidth/2-143,displayHeight/2-40,20,20)
 bg.addImage(bgImg)
bg.scale = 1.1
...
killSprite = createSprite(1155,50,10,10);
...
function fire(){
  ...
  fireLaser.addImage(fireImg);
  fireLaser.scale = 0.414;
